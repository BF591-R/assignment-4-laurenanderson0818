...
caption_4 <- "Variance explained by each principal component and cumulative variance explained. PC1 shows the largest proportion of variance, with other PCs showing progressively less. The cumulative curve indicates how many PCs are required to explain the majority of variability in the dataset."
caption_5 <- "Scatter plot of the first two principal components (PC1 vs. PC2), with samples colored by SixSubtypesClassification. This plot shows how samples cluster based on the primary sources of variation in the data."
caption_8 <- "Heatmap of normalized intensity values for significantly differentially expressed probes (FDR < 0.01). Rows represent probes and columns represent samples, with hierarchical clustering applied to both. Color intensity reflects expression levels, revealing patterns and potential clustering among samples and genes."
```
...
variance_tibble$principal_components <- factor(
  ...
  levels = paste0("PC", seq_along(variance_tibble$principal_components))
)
